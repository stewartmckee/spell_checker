...
describe SpellChecker do
  ...
  it "should return false for an invalid paragraph" do
    result = @spell.check_paragraph("This spell checker should varify this paragraph")
    result.length.should == 1
    result[0][:stemmed_word].should == "varifi"
    result[0][:searched_word].should == "varify"
    result[0][:suggested_words].should include "verify"
  end
